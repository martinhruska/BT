...
/*
              ...
              std::cout << "proc size " <<  processed.size() << std::endl;
              std::cout << "state " << q << std::endl;
              std::cout << "Macro state ";
              for (auto s : *Q) {std::cout << s << " ";}; std::cout << std::endl;
*/
...
/*
  std::cout << "Proc: " << processed.size() << std::endl;
  std::cout << "Temp: " << temporary.size() << std::endl;
  std::cout << "Next: " << next.size() << std::endl;
  std::cout << "Post: " << post.data().size() << std::endl;
  */
	return true;
