#! /bin/bash
# @1 path to eval scripts
# @2 file with results of ocaml hkc
# @3 results of vata
# @4 timeout of vata
EVALSCRIPTS=$1
EDITED="$3_edited"
...
python $EVALSCRIPTS/toGnuPlot.py -a hkc_transformed $EDITED > evals_ac.data; # hkc because number of states
