...
// nebrat first, second ale iterator a pokud je nullptr je vlozen jinak na
			if (!tupleSet) {
...
public:   // public methods
	...
	/*
	 * Parsing automaton to internal structure.
	 * It translates automaton structure to internal AutoDescription
	 * structure and calls another function creating internal representation
	 * of automaton.
	 * @param parser Parsing string to autodescrition strcuture
	 * @param str Contains automaton in string format
	 * @param stateDict Dictionary for translating of state names 
	 * to internal state numbers 
	 */
	...
	/*
   * Function transforms the AutoDescription structure to internal
   * representation of automaton.
   * @param desc AutoDescription of automaton
	 * @param stateDict Dictionary for translating of state names 
   */ 
