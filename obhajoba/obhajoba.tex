...
\begin{center}
	\scalebox{0.7}
	{
		\includegraphics[scale=0.55]{congr1.pdf}
		\hspace{0.55cm}
...
\frame{\frametitle{Algoritmus výpočtu kongruenčního uzávěru}
  \begin{itemize}
    \item \textcolor{red}{$A\subseteq B \Leftrightarrow A\cup B = B$}
...
\frame{\frametitle{Porovnání s~OCaml verzí}
  ...
  \vspace{0.5cm}
   ...
   \hline
    ...
    vítězí & $8\%$ & $92\%$ \\ \hline
    rychlejší & $0.48\times$ & $78\times$ \\ \hline
   \end{tabular}
 \end{center}
}
\frame{\frametitle{Porovnání s~VATA pro strom. automaty}
  ...
  \vspace{0.5cm}
   ...
   \hline
    ...
    vítězí & $7\%$ & $93\%$ \\ \hline
    rychlejší & $0.15\times$ & $135\times$ \\ \hline
   \end{tabular}
 \end{center}
} 
