...
would bring only unnecessary overhead 
...
because $\mathcal{C}$ now shares the look-up table with automaton $\mathcal{B}$,
...
A more detailed analysis of the cases where the algorithm checks language inclusion over tree automata significantly 
