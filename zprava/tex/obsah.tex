...
\label{defFA}
    ...
    An example of a NFA over $\Sigma=\{a,b,c,d\}$ is shown in the figure \ref{pic_ex_nfa}. 
...
\newline
		...
		\end{itemize}
    An example of a DFA over $\Sigma=\{a,b,c\}$ is given in the figure \ref{pic_ex_dfa}.
