...
The new extension of the VATA library uses the explicit encoding for representation of finite automata. 
...
algorithm over NFA but it has not been evaluated and optimized which could bring another improvement in performance. 
Yet another interesting direction is to find suitable use of cases of DFA for various task and evaluate whether they can improved by the use of NFA, in
