...
the \emph{breadth-search} algorithm or the \emph{depth-first} search algorithm what
...
which should be futher processed.
...
are stored to macrostate cache and it is worked only with pointers to this macrostates in cache.
...
\subsection{Optimization Used for Equivalence Checking}
\subsection{Optimization Used for Inclusion Checking}
