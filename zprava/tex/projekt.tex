...
\projectinfo{
  ...
  zmíněných přístupů v podobě nového rozšíření knihovny VATA. Tato implementace byla otestována a je zhruba stonásobně rychlejší v 90\% testovaných případů
  nežli jiné implementace.},
  abstract.en={
    ...
    and beats the other implementation in over 90\% for about a hundred times.},
  %Prohlaseni
