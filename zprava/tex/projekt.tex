...
\projectinfo{
  ...
  %Abstract
  abstract.cs={Nedeterministické konečné automaty jsou používány v mnoha oblastech informatiky, mimo jiné také ve formální verifikaci nebo při návrhu
  ...
  nežli jiné implementace, oproti nimž je dvakrát až řádově stokrát rychlejší.},
  abstract.en={
