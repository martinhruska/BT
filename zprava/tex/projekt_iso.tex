...
\projectinfo{
  ...
  %Nazev prace
  title.cs={Efektivní algoritmy pro práci s koneènými automaty},  %nazev prace v cestine
  title.en={Efficient Algorithms for Finite Automata}, %nazev prace v anglictine
  %Autor
  author={Martin Hru¹ka},   %jmeno prijmeni autora
  ...
  %Prohlaseni
  declaration={Prohla¹uji, ¾e jsem tuto bakaláøskou práci vypracoval samostatnì pod vedením pana Ing. Ondøeje Lengála},
  %Podekovani (nepovinne)
  acknowledgment={Rád bych tímto podìkoval vedoucímu této práce, Ing. Ondøeji Lengálovi, za odborné rady a vedení pøi tvorbì práce.} % nepovinne
}
